...
public class MLRules extends AbstractClassifier implements OptionHandler, TechnicalInformationHandler{
	...
	public int bigNumber = 862897923;
	...
	public void buildClassifier(Instances instances) throws Exception {
		...
		for (int m = 0; m < nRules; m++) {
			...
			writeLog("getPercentage:");
			writeLog(String.valueOf(getPercentage()));
			...
			writeLog("covered instances MLRULES");
	...
	public void updateFunction(double[] decision)  {
		writeLog("Ponizej decision jakie o jakie updatuje");
