...
def crossvalidation_fold(X, y, train_indices, test_indices, model, model_name, i_crossval):
    ...
    if model_name in ['Ender_Gradient', 'Ender_Newton-Raphson']:
        ...
        n_rules = None
    return (time_elapsed, accuracy_train, accuracy_train_rule_number, accuracy_test, accuracy_test_rule_number, f1_train, f1_train_rule_number, f1_test, f1_test_rule_number, n_rules, i_crossval)
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        for model_name, model in models.items():
            ...
            for (time_elapsed, accuracy_train, accuracy_train_rule_number, accuracy_test, accuracy_test_rule_number, f1_train, f1_train_rule_number, f1_test, f1_test_rule_number, n_rules, i_crossval) in results:
